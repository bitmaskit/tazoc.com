<script lang="ts">
    ...
    async function handleSubmit(e: Event) {
        ...
        try {
            ...
            alert(
                "Email/password login not implemented yet. Please use GitHub OAuth.",
            );
        } catch (error) {
...
{#if open}
    ...
    >
        ...
        >
            <!-- Modal panel -->
            <div
                class="relative transform overflow-hidden bg-gray-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-0"
            >
                <!-- Close button -->
                ...
                >
                    ...
                    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
                        <div
                            class="bg-gray-800/50 px-6 py-12 outline -outline-offset-1 outline-white/10 sm:rounded-lg sm:px-12"
                        >
                            ...
                            <div>
                                <div class="mt-10 flex items-center gap-x-6">
                                    ...
                                    ></div>
                                    <p
                                        class="text-sm/6 font-medium text-nowrap text-white"
                                    >
                                        Or continue with
                                    </p>
                                    <div
