        ...
        <main class="isolate">
                ...
                <div class="py-24 sm:py-32 lg:pb-40">
                    <div class="mx-auto max-w-7xl px-6 lg:px-8">
                        ...
                        <div class="mt-16 flow-root sm:mt-24">
                            <div
                                class="-m-2 rounded-xl bg-white/2.5 p-2 ring-1 ring-white/10 ring-inset lg:-m-4 lg:rounded-2xl lg:p-4"
                            >
                                <img
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div class="mt-16 flex justify-center">
                    <p
                        class="relative rounded-full bg-gray-800/25 px-4 py-1.5 text-sm/6 text-gray-400 inset-ring inset-ring-white/10"
                    >
                        <span class="hidden md:inline"
                            >Transistor saves up to $40,000 per year, per
                            employee by working with us.</span
                        >
                        <a
                            href="#"
            ...
            <div class="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
                <div
                    class="relative overflow-hidden bg-black px-6 py-20 after:pointer-events-none after:absolute after:inset-0 after:inset-ring after:inset-ring-white/10 sm:rounded-3xl sm:px-10 sm:py-24 after:sm:rounded-3xl md:px-12 lg:px-20"
                >
                    <img
                    ...
                    >
                        <div
                            class="aspect-1097/845 w-274.25 bg-linear-to-r from-[#ff4694] to-[#776fff] opacity-[0.30]"
                            style="
                                clip-path: polygon(
                                    74.1% 44.1%,
                                    100% 61.6%,
                    ...
                    >
                        <div
                            class="aspect-1097/845 w-274.25 bg-linear-to-r from-[#ff4694] to-[#776fff] opacity-20"
                            style="
                                clip-path: polygon(
                                    74.1% 44.1%,
                                    100% 61.6%,
            ...
            <div class="py-24 sm:pt-48">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-4xl text-center">
                        ...
                        <p
                            class="mt-2 text-4xl font-semibold tracking-tight text-balance text-white sm:text-5xl"
                        >
                            Pricing that grows with you
                        </p>
                    </div>
                    <p
                        class="mx-auto mt-6 max-w-2xl text-center text-lg/8 text-pretty text-gray-400 sm:text-xl/8"
                    >
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <p
                                        ...
                                        class="rounded-full bg-indigo-400/10 px-2.5 py-1 text-xs/5 font-semibold text-indigo-400"
                                    >
                                        Most popular
                                    </p>
                                </div>
                                ...
                                <ul
                                    role="list"
                                    class="mt-8 space-y-3 text-sm/6 text-gray-400"
                                >
                                    <li
            ...
            >
                ...
                <dl class="mt-20 divide-y divide-white/10">
                    ...
                    >
                        <dt
                            class="text-base/7 font-semibold text-white lg:col-span-5"
                        >
                            {{ faq.question }}
                        </dt>
                        <dd class="mt-4 lg:col-span-7 lg:mt-0">
                            <p class="text-base/7 text-gray-400">
                                {{ faq.answer }}
                            </p>
                        </dd>
                    </div>
