  ...
  <TransitionRoot as="template" :show="open">
    <Dialog class="relative z-50" @close="$emit('close')">
      <TransitionChild
        ...
        leave-to="opacity-0"
      >
        <div class="fixed inset-0 bg-black/20 backdrop-blur-md transition-opacity" />
      </TransitionChild>
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <DialogPanel class="relative transform overflow-hidden bg-gray-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-0">
              <!-- Close button -->
              <div class="absolute right-0 top-0 pr-4 pt-4">
                <button
                  type="button"
                  class="rounded-md bg-gray-900 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  @click="$emit('close')"
                >
              ...
              <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                  <div class="h-10 w-auto text-indigo-400 font-bold text-2xl text-center">
                    LinkShort
                  </div>
                  <h2 class="mt-6 text-center text-2xl/9 font-bold tracking-tight text-white">
                  ...
                  <div class="bg-gray-800/50 px-6 py-12 outline -outline-offset-1 outline-white/10 sm:rounded-lg sm:px-12">
                    <form class="space-y-6" @submit.prevent="handleSubmit">
                      ...
                      <div class="flex items-center justify-between">
                        <div class="flex gap-3">
                          ...
                          <label for="remember-me" class="block text-sm/6 text-white">
                            Remember me
                          </label>
                        </div>
                    ...
                    <div>
                      <div class="mt-10 flex items-center gap-x-6">
                        ...
                        <p class="text-sm/6 font-medium text-nowrap text-white">
                          Or continue with
                        </p>
                        <div class="w-full flex-1 border-t border-white/10" />
                      </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    alert('Email/password login not implemented yet. Please use GitHub OAuth.')
  } catch (error) {
