	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/callback/_server.ts.js'))
			},
			{
				id: "/api/links",
				pattern: /^\/api\/links\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/links/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/links/_shortCode_/_server.ts.js'))
			},
			{
				id: "/api/login",
				pattern: /^\/api\/login\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/shorten/_server.ts.js'))
			},
			{
				id: "/app",
				pattern: /^\/app\/?$/,
			...
			},
			{
				...
				params: [{"name":"shortCode","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/_shortCode_/_server.ts.js'))
			}
		],
